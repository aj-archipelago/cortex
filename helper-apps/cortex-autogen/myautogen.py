    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                import requests
            - You can upload the file to Azure Blob Storage. AZURE_STORAGE_CONNECTION_STRING is environment variable available for azure blob storage. In azure blob use only "archipelagomlp3886134442" with "autogentempfiles" container for your file storage. If you upload a file to azure blob you must include the file's azure blob URL in your response. Verify the file is uploaded to the container "autogentempfiles" before returning the URL. example url: https://archipelagomlp3886134442.blob.core.windows.net/autogentempfiles/FILE.EXT
            - When everything works fine and you complete the users request upload your code file to Azure Storage with a prefix "code"+ "timestamp" and with nice detailed descriptive filename and return the URL of the code file. You can use the same azure blob storage connection string to upload the code file.
