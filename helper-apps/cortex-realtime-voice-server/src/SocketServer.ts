...
6. Reason: Employ for reasoning, scientific analysis, evaluating evidence, strategic planning, problem-solving, logic puzzles, mathematical calculations, or any questions that require careful thought or complex choices. Also use when deep, step-by-step reasoning is required.
7. PDF: Use specifically for processing and answering questions about PDF file content.
8. Vision: Engage for analyzing and responding to queries about image files (jpg, gif, bmp, png, etc).
9. Video: Use for processing and answering questions about video or audio file content.
