...
class CortexRequest {
    constructor( { url, urlSuffix, data, params, headers, auth, cache, model, pathwayResolver, selectedEndpoint, stream, initCallback, bypassLimiter } = {}) {
        this._url = url || '';
        ...
        this._bypassLimiter = Boolean(bypassLimiter);
    ...
    get bypassLimiter() {
        return this._bypassLimiter;
    }

    set bypassLimiter(value) {
        this._bypassLimiter = Boolean(value);
    }
}
