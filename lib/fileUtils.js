...
async function addFileToCollection(contextId, contextKey, url, gcs, filename, tags = [], notes = '', hash = null, fileUrl = null, pathwayResolver = null, permanent = false) {
    ...
    const storageHash = finalHash || (finalUrl ? await computeBufferHash(Buffer.from(finalUrl)) : null);
        ...
        try {
            ...
            if (redisClient) {
                ...
                const fileData = {
                    ...
                    url: finalUrl || existingData.url, // Use new URL if provided, otherwise keep existing
