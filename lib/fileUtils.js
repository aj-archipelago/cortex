            ...
            if (!existsByUrl && !existsByGcs && !existsByHash) {
                ...
                if (existingFile) {
                    ...
                    if (file.url && !existingFile.url) {
                        ...
                        // Update filename with new URL extension (preserve original base name if we have it)
                    ...
                    if (file.gcs && !existingFile.gcs) {
                        ...
                        // Update filename with new GCS URL extension (preserve original base name if we have it)
                        existingFile.filename = combineFilenameWithUrlExtension(existingFile.filename, existingFile.url, existingFile.gcs);
                    }
                    // Update URL/GCS and filename if they have changed
                    ...
                    if (file.filename && file.filename !== existingFile.filename) {
